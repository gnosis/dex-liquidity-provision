...
const { buildTransferApproveDeposit } = require("./utils/trading_strategy_helpers")
...
module.exports = async callback => {
  try {
    ...
    const transaction = await buildTransferApproveDeposit(masterSafe.address, deposits, web3, artifacts, true)
